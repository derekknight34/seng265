...
class RandomShape:
    ...
    def __int__(self):
        ...
        self.W: int = gen_int(Irange(PyArtConfig.WMIN, PyArtConfig.WMAX))
        self.H: int = gen_int(Irange(PyArtConfig.HMIN, PyArtConfig.HMAX))
        self.R: int = gen_int(Irange(PyArtConfig.REDMIN, PyArtConfig.REDMAX))
        self.G: int = gen_int(Irange(PyArtConfig.GREENMIN, PyArtConfig.GREENMAX))
        self.B: int = gen_int(Irange(PyArtConfig.BLUEMIN, PyArtConfig.BLUEMAX))
        self.OP: float = gen_float(Frange(PyArtConfig.OPMIN, PyArtConfig.OPMAX))
