...
/**
 * Function:  add_and_inc
 * ----------------------
 * @brief  Allows to add a new node to the list respecting an order, if the node is already in the list
 *          the counter is incremented.
 *
 * @param list The list where the node will be added (i.e., a pointer to the first element in the list).
 * @param new The node to be added to the list.
 *
 * @return node_t* A pointer to the first element in the list.
 *
 */

node_t *add_and_inc(node_t *list, node_t *new){
    ...
    list = add_inorder(list, new);

    return list;
}

/**
 * Function:  add_inorder_count
 * ----------------------
 * @brief  Allows to add a new node to the list respecting in order of highest to lowest counter value.
 *
 * @param list The list where the node will be added (i.e., a pointer to the first element in the list).
 * @param new The node to be added to the list.
 *
...
node_t *add_inorder_count(node_t *list, node_t *new){
    if (list == NULL){
        new->next = NULL;
        return new;
    }
 ...
 * Function:  add_inorder_count
 * ----------------------
 * @brief  Allows to add a new node to the list respecting in order of lowest to highest counter value.
 *
 * @param list The list where the node will be added (i.e., a pointer to the first element in the list).
 * @param new The node to be added to the list.
 *
...
node_t *add_in_asending_order_count(node_t *list, node_t *new){
    if (list == NULL){
        new->next = NULL;
        return new;
    }
